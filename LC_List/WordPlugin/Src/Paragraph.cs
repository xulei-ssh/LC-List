...
namespace WordPlugin
{
  ...
  public class Paragraph : InsertBeforeOrAfter
  {
    ...
    public Alignment Alignment
    {
      get
      {
        ...
        if( jc != null )
        {
          ...
          {
            case "left":
              return WordPlugin.Alignment.left;
            case "right":
              return WordPlugin.Alignment.right;
            case "center":
              return WordPlugin.Alignment.center;
            case "both":
              return WordPlugin.Alignment.both;
          }
        }
      ...
      set
      {
        ...
        if( alignment != WordPlugin.Alignment.left )
        {
          if( jc == null )
    ...
    //     WordPlugin.Image img = document.AddImage(@"Image.jpg");
    //
    ...
    /// <summary>
    /// Inserts a specified instance of System.String into a WordPlugin.DocX.Paragraph at a specified index position.
    /// </summary>
    /// <example>
    /// <code> 
    /// // Create a document using a relative filename.
    ...
    ///
    ///    // Add an Image to this document.
    ///    WordPlugin.Image img = document.AddImage(directory_documents + "purple.png");
    ///
    ...
    public Paragraph UnderlineStyle( UnderlineStyle underlineStyle )
    {
      ...
      {
        case WordPlugin.UnderlineStyle.none:
          value = string.Empty;
          break;
        case WordPlugin.UnderlineStyle.singleLine:
          value = "single";
          break;
        case WordPlugin.UnderlineStyle.doubleLine:
          value = "double";
          break;
        default:
    ...
    public Paragraph CapsStyle( CapsStyle capsStyle )
    {
      switch( capsStyle )
      {
        case WordPlugin.CapsStyle.none:
          break;
    ...
    public Paragraph Highlight( Highlight highlight )
    {
      switch( highlight )
      {
        case WordPlugin.Highlight.none:
          break;
    ...
    public Paragraph Misc( Misc misc )
    {
      switch( misc )
      {
        case WordPlugin.Misc.none:
          break;

        case WordPlugin.Misc.outlineShadow:
          {
    ...
    public Paragraph StrikeThrough( StrikeThrough strikeThrough )
    {
      ...
      {
        case WordPlugin.StrikeThrough.strike:
          value = "strike";
          break;
        case WordPlugin.StrikeThrough.doubleStrike:
          value = "dstrike";
          break;
        default:
          return this;
    ...
    /// <summary>
    /// Removes characters from a WordPlugin.DocX.Paragraph.
    /// </summary>
    /// <example>
    /// <code>
    /// // Create a document using a relative filename.
