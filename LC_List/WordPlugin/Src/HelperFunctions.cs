...
namespace WordPlugin
{
  internal static class HelperFunctions
  {
    ...
    internal static XDocument AddDefaultStylesXml( Package package )
    {
      ...
      stylesDoc = HelperFunctions.DecompressXMLResource( "WordPlugin.Resources.default_styles.xml.gz" );
        ...
        switch( c )
        {
          case '\t':
            if( sb.Length > 0 )
            {
              ...
              WordPlugin.Text.PreserveSpace( t );
    ...
    internal static XDocument AddDefaultNumberingXml(Package package)
    {
      ...
      numberingDoc = DecompressXMLResource("WordPlugin.Resources.numbering.xml.gz");
